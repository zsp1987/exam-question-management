...
export default function ProfilePage() {
	...
	const handleAvatarPick = async (e) => {
		...
		if (file.size > 2 * 1024 * 1024) {
			setErr(
				lang === "en"
					? "Avatar must be ≤2MB (jpg/png/webp)"
					: "头像需 ≤2MB（jpg/png/webp）",
			);
			return;
		}
		setErr("");
	...
	return (
		<div className="max-w-2xl mx-auto space-y-6 pb-12">
			...
			{msg && (
				<div className="bg-emerald-50 border border-emerald-200 text-emerald-700 text-xs px-4 py-3 rounded-xl">
					{msg}
				</div>
			)}
