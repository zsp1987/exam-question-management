...
const TRANSLATIONS = {
  en: {
    ...
    // Nav Items
    navExamFolders: 'Certification Exams',
    navExamFoldersDesc: 'Organize approved questions into certification exam pools',
    ...
    // Search & Filters
    searchPlaceholder: 'Search by keyword, scenario, formulas, explanation, or domain...',
    searchBtn: 'Search',
    ...
    editorChangeSummaryPlaceholder: 'e.g. Added trade-off table and refined LaTeX formula',
    ...
    // Exam Folders
    examFoldersTitle: 'Certification Exam Folders',
    examFoldersSubtitle: 'Curate, organize, and package approved questions into formal certification exams',
    btnCreateExam: 'New Exam Folder',
    examCode: 'Exam Code',
    ...
    emptyExamFolder: 'No questions assigned to this exam folder yet.',

    // Review Hall
    reviewHallTitle: 'Exam Quality & Certification Review Hall',
    reviewHallSubtitle: 'Enforce rigorous certification standards, formula correctness, and scenario validity',
    ...
    reviewCommentPlaceholder: 'Enter item evaluation, rationale, or necessary revisions...',

    // Reports
    reportsTitle: 'Certification Pool Analytics & Paper Generator',
    reportsSubtitle: 'Domain distribution, difficulty matrix, passing rate, and export engine',
  ...
  zh: {
    ...
    // Nav Items
    navExamFolders: '认证考试文件夹',
    navExamFoldersDesc: '将已审核考题归入指定专业认证考试科目',
    navQuestions: '题库检索大厅',
    ...
    // Search & Filters
    searchPlaceholder: '输入关键词全文检索（考题标题、题干场景、公式、选项、解析）...',
    searchBtn: '检索题库',
    allTypes: '全部题型',
    allStatuses: '全部审核状态',
    allSubjects: '全部认证科目',
    ...
    // Exam Folders
    examFoldersTitle: '认证考试文件夹与科目归档',
    examFoldersSubtitle: '将已审核通过的认证考题按考纲结构归入指定专业认证考试科目',
    btnCreateExam: '创建新认证考试',
    examCode: '认证代号',
    ...
    emptyExamFolder: '当前认证考试文件夹尚未收录考题。',

    // Review Hall
    reviewHallTitle: '认证考题教研评审大厅',
    reviewHallSubtitle: '严格把关认证考题质量、场景真实性、公式严谨性与排版规范',
    pendingQueue: '待审队列',
    reviewHistory: '评审流转记录',
    btnApprove: '审核通过入库',
    btnReject: '驳回修改',
    reviewComment: '评审意见与修改要求',
    reviewCommentPlaceholder: '请输入针对本考题的专业评审意见、采分建议或修改要求...',
