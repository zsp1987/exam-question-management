...
export function AuthProvider({ children }) {
	...
	async function autoDemoLogin(usersList) {
		if (usersList && usersList.length > 0) {
			...
			const defaultUser =
				usersList.find((u) => (u.role === "WRITER" || u.role === "TEACHER")) || usersList[0];
			try {
	...
	const isTeacher = (user?.role === "WRITER" || user?.role === "TEACHER") || isReviewer || isAdmin;
	const isWriter = isTeacher;
